...
console.log(`${cansLeft >= 5 ? "we are stocked" : "time to restock"}`);
...
console.log(`${currentHour === 0o0 || (currentHour >= 7 && currentHour <= 24) ? "Unleash the beast!" : "Better stick to water."}`)
// in the above code i check for both 24 and 00 as midnight.
